...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    static final int DATABASE_VERSION = 3; //Increment this number to give the user a notification that a new DB version is available and the choice if he wants to use it
