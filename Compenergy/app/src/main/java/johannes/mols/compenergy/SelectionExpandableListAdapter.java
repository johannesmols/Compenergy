...
class SelectionExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    SelectionExpandableListAdapter(Context context, List<String> categories, HashMap<String, List<Carrier>> carriers) {
